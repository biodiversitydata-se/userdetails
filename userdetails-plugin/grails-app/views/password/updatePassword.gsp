...
<asset:script type="text/javascript">
    $(function(){
        ...
        var $form = $("form[name='updatePasswordForm']");
...
<div class="row">
    ...
    <g:if test="${grailsApplication.config.getProperty('userdetails.features.requirePasswordForUserUpdate', Boolean, true)}">
        <g:render template="../registration/passwordPolicy" model="[passwordPolicy: passwordPolicy ]"/>
    </g:if>
    ...
    <div class="row">
        ...
        <g:form useToken="true" name="updatePasswordForm" action="updatePassword">

            <div class="form-group">
                <label for="current-password">Your current password</label>
                <input id="current-password" type="password" class="form-control" name="currentPassword" value=""/>
            </div>
