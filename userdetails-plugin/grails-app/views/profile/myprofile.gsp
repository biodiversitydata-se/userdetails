                    ...
                    <div class="d-flex">
                        ...
                        <div class="content">
                            <h4 id="records-annotated">
                                <a href="${grailsApplication.config.getProperty('biocache.search.url')}%22${user.uiId}%22">
                            ...
                            <div class="content">
                                ...
                                <g:if test="${props.inaturalistId}">
                                    ...
                                    <ul>
                                        ...
                                        <li><u:link baseProperty="biocache.search.baseUrl" params='[q: grailsApplication.config.getProperty("inaturalist.searchQuery") + " OR " + grailsApplication.config.getProperty("inaturalist.sightingsSearchQuery"), fq: "alau_user_id:${props.inaturalistUsername} OR alau_user_id:\"${user.uiId}\""]'>View my iNaturalist observations and my ${grailsApplication.config.skin.orgNameShort} Sightings in ${grailsApplication.config.skin.orgNameShort}</u:link></li>
                                    </ul>
